fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // let output_filename = "../resources/Overworld_Tiles_aligned_3.png";
...
impl AppData {
    ...
    fn resize_window(&mut self, size: [i32;2]) {
        ...
        self.recalculate_aspect_ratio();
        self.recalculate_infobox_height();
    ...
    fn recalculate_aspect_ratio(&self) {
        let window_aspect_ratio =
            (self.window_size[0] as f32) / (self.window_size[1] as f32 - self.infobox_height);
    ...
    fn recalculate_infobox_height(&self) {
        let infobox_height = 2.0 * self.infobox_height / (self.window_size[1] as f32);
        unsafe {
            gl::UseProgram(self.gl_data.program);
            let location = gl::GetUniformLocation(self.gl_data.program,
